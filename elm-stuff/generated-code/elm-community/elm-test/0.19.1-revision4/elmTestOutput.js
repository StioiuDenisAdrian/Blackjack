...
var $author$project$Card$faceToString = function (f) {
	switch (f.$) {
		case 'Ace':
			return 'Ace';
		case 'Two':
...
var $author$project$Card$cardToString = function (_v0) {
	var face = _v0.a.face;
	var suit = _v0.a.suit;
	return $author$project$Card$faceToString(face) + (' of ' + $author$project$Card$suitToString(suit));
};
	...
	var otherCards = A2(
		...
		function (x) {
			return !A2(
				...
				'Ace',
				$author$project$Card$cardToString(x));
		},
		cards);
	var sumWithoutAces = $elm$core$List$sum(
		$elm$core$List$concat(
			A2($elm$core$List$map, $author$project$Card$cardValue, otherCards)));
	var head = function (l) {
		if (!l.b) {
			return 0;
		} else {
	...
	var possibleScores = A2(
		...
		A3(
			...
			_List_fromArray(
				[sumWithoutAces]),
			aceList));
	return A2($elm$core$List$member, 21, possibleScores) ? 21 : (_Utils_eq(
		A2(
			$elm$core$List$filter,
			function (x) {
				return x < 21;
			...
			possibleScores),
		_List_Nil) ? head(
		$elm$core$List$reverse(possibleScores)) : head(
		A2(
			$elm$core$List$filter,
			function (x) {
				return x < 21;
				...
				[
					...
					_List_fromArray(
						[
							...
							{face: $author$project$Card$King, suit: $author$project$Card$Hearts})
						]),
					10),
					A4(
					$author$project$Tests$genTest,
					...
					_List_fromArray(
						[
							$author$project$Card$Card(
							{face: $author$project$Card$Two, suit: $author$project$Card$Hearts})
						]),
					2),
					A4(
					$author$project$Tests$genTest,
					...
					_List_fromArray(
						[
							...
							{face: $author$project$Card$Two, suit: $author$project$Card$Hearts}),
							$author$project$Card$Card(
							{face: $author$project$Card$King, suit: $author$project$Card$Spades})
						]),
					12),
					A4(
					$author$project$Tests$genTest,
					...
					_List_fromArray(
						[
							$author$project$Card$Card(
							{face: $author$project$Card$Ace, suit: $author$project$Card$Hearts}),
							$author$project$Card$Card(
							{face: $author$project$Card$King, suit: $author$project$Card$Spades})
						]),
					21),
					...
					_List_fromArray(
						[
							...
							{face: $author$project$Card$Ace, suit: $author$project$Card$Hearts}),
							$author$project$Card$Card(
							{face: $author$project$Card$Five, suit: $author$project$Card$Hearts}),
							$author$project$Card$Card(
							{face: $author$project$Card$Seven, suit: $author$project$Card$Spades})
						]),
					13),
					A4(
					$author$project$Tests$genTest,
					...
					_List_fromArray(
						[
							...
							{face: $author$project$Card$King, suit: $author$project$Card$Hearts}),
							$author$project$Card$Card(
							{face: $author$project$Card$Ten, suit: $author$project$Card$Clubs}),
							$author$project$Card$Card(
							{face: $author$project$Card$Ace, suit: $author$project$Card$Spades})
						]),
					21),
					A4(
					$author$project$Tests$genTest,
					...
					_List_fromArray(
						[
							...
							{face: $author$project$Card$Ace, suit: $author$project$Card$Spades}),
							$author$project$Card$Card(
							{face: $author$project$Card$Ace, suit: $author$project$Card$Clubs}),
							$author$project$Card$Card(
							{face: $author$project$Card$Ten, suit: $author$project$Card$Clubs}),
							$author$project$Card$Card(
							{face: $author$project$Card$King, suit: $author$project$Card$Clubs})
						]),
					22)
				]))
		]));
var $author$project$Test$Generated$Main1912419751$main = A2(
	$author$project$Test$Runner$Node$run,
	{
		globs: _List_Nil,
		paths: _List_fromArray(
			['C:\\Users\\Denis\\Desktop\\Functional Programming\\Project (1)\\tests\\Example.elm', 'C:\\Users\\Denis\\Desktop\\Functional Programming\\Project (1)\\tests\\Tests.elm']),
		processes: 8,
		report: $author$project$Test$Reporter$Reporter$ConsoleReport($author$project$Console$Text$UseColor),
		runs: $elm$core$Maybe$Nothing,
		seed: 337700748094511
	},
...
_Platform_export({'Test':{'Generated':{'Main1912419751':{'init':$author$project$Test$Generated$Main1912419751$main($elm$json$Json$Decode$int)(0)}}}});}(this));
return this.Elm;
})({});
var pipeFilename = "\\\\.\\pipe\\elm_test-10264-1";
